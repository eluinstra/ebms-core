...
import nl.clockwork.ebms.common.deliverytask.DeliveryTaskTools;
import nl.clockwork.ebms.common.deliverytask.QuartzKafkaTaskManagerType;
...
public class KafkaJob extends QuartzJobBean
{
	...
	protected void executeInternal(JobExecutionContext context) throws JobExecutionException
	{
		...
		try
		{
			...
			val task = DeliveryTaskTools.createDeliveryTask(properties);
