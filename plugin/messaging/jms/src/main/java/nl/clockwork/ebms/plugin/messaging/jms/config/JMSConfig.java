...
import nl.clockwork.ebms.config.TransactionManagerConfig.AtomikosTransactionManagerType;
import nl.clockwork.ebms.config.TransactionManagerConfig.DefaultTransactionManagerType;
import nl.clockwork.ebms.config.TransactionManagerConfig.TransactionManagerType;
import nl.clockwork.ebms.plugin.messaging.jms.EbMSBrokerFactoryBean;
import lombok.val;
