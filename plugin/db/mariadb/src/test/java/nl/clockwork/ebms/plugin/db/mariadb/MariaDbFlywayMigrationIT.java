 ...
 */
package nl.clockwork.ebms.plugin.db.mariadb;
...
{
	private static final String JDBC_URL = "jdbc:tc:mariadb:11:///ebms";
	private static final String USER = "test";
	private static final String PASSWORD = "test";

	@ParameterizedTest(name = "mariadb migrations apply cleanly: {0}")
