...
ALTER TABLE message_event DROP COLUMN message_nr CASCADE;
ALTER TABLE delivery_log DROP COLUMN message_nr CASCADE;
ALTER TABLE delivery_task DROP COLUMN message_nr CASCADE;
ALTER TABLE ebms_attachment DROP COLUMN message_nr CASCADE;
ALTER TABLE ebms_message DROP COLUMN message_nr CASCADE;

call sysproc.admin_cmd('reorg table ebms_message');
call sysproc.admin_cmd('reorg table ebms_attachment');
call sysproc.admin_cmd('reorg table delivery_task');
call sysproc.admin_cmd('reorg table delivery_log');
call sysproc.admin_cmd('reorg table message_event');
