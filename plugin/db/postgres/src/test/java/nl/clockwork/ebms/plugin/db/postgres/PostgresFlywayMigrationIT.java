 ...
 * applying them to a real PostgreSQL container started on demand via Testcontainers' JDBC URL
 * support ({@code jdbc:tc:postgresql:...}). Replaces the former {@code validate-migrations.sh}
