 ...
 */
package nl.clockwork.ebms.plugin.db.hsqldb;
...
{
	private static final String JDBC_URL = "jdbc:hsqldb:mem:ebms;hsqldb.tx=mvcc";
	private static final String USER = "SA";
	private static final String PASSWORD = "";

	@ParameterizedTest(name = "hsqldb migrations apply cleanly: {0}")
