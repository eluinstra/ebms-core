 ...
 * applying them to a real Oracle Free container started on demand via Testcontainers' JDBC URL
 * support ({@code jdbc:tc:oracle:...}). The default image used by the
 * {@code testcontainers-oracle-free} module is {@code gvenzl/oracle-free}. Replaces the former
 * {@code validate-migrations.sh} harness for this plugin.
 */
class OracleFlywayMigrationIT
{
	private static final String JDBC_URL = "jdbc:tc:oracle:23-slim-faststart:///freepdb1";
