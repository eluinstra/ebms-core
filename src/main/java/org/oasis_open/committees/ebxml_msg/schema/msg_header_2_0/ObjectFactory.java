 ...
 * org.oasis_open.committees.ebxml_msg.schema.msg_header_2_0 package.
 * <p>
...
public class ObjectFactory
{
	...
	private final static QName _DuplicateElimination_QNAME =
			new QName("http://www.oasis-open.org/committees/ebxml-msg/schema/msg-header-2_0.xsd", "DuplicateElimination");
	...
	public JAXBElement<Instant> createTimeToLive(Instant value)
	{
		return new JAXBElement<Instant>(_TimeToLive_QNAME, Instant.class, null, value);
	}
	...
	@XmlJavaTypeAdapter(InstantAdapter.class)
	public JAXBElement<Instant> createTimestamp(Instant value)
	{
		return new JAXBElement<Instant>(_Timestamp_QNAME, Instant.class, null, value);
	}
