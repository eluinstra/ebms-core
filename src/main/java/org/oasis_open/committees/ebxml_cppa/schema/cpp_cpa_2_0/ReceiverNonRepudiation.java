...
@XmlType(name = "", propOrder = {"nonRepudiationProtocol", "hashFunction", "signatureAlgorithm", "signingSecurityDetailsRef"})
@XmlRootElement(name = "ReceiverNonRepudiation")
public class ReceiverNonRepudiation implements Serializable
{
