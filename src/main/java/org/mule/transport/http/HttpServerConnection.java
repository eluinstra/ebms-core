/*
 * $Id: HttpServerConnection.java 13643 2008-12-15 21:16:15Z aperepel $
 * --------------------------------------------------------------------------------------
...
public class HttpServerConnection
{
    ...
    public void writeResponse(final HttpResponse response) throws IOException, TransformerException
    {
        ...
        //PATCH START
        if (CXFHeaderManager.getContentType() != null)
        	response.setHeader(new Header(HttpConstants.HEADER_CONTENT_TYPE,CXFHeaderManager.getContentType()));
        if (CXFHeaderManager.getStatusCode() != null)
        	response.setStatusLine(HttpVersion.HTTP_1_1,CXFHeaderManager.getStatusCode());
        //PATCH END
