...
public class EbMSAcknowledgmentOutToMap extends AbstractMessageAwareTransformer
{
  protected transient Log logger = LogFactory.getLog(getClass());

	public EbMSAcknowledgmentOutToMap()
	{
	...
	public Object transform(MuleMessage message, String outputEncoding) throws TransformerException
	{
		try
		{
			EbMSAcknowledgment msg = (EbMSAcknowledgment)message.getPayload();
			...
			map.put("message_content",XMLMessageBuilder.getInstance(Acknowledgment.class).handle(msg.getAcknowledgment()));
			map.put("status",null);
