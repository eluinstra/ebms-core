 ...
 */
package nl.clockwork.ebms.server.message.processor;
...
import nl.clockwork.ebms.server.message.processor.message.EbMSMessageProcessor;
import nl.clockwork.ebms.server.message.processor.pong.PongProcessor;
import nl.clockwork.ebms.server.message.processor.status.StatusResponseProcessor;
...
public class EbMSMessageRouter
{
	...
	private EbMSDocument processMessage(Instant timestamp, EbMSDocument document, EbMSMessage message)
			...
			TransformerFactoryConfigurationError, TransformerException, XPathExpressionException, EbMSProcessorException
	{
		return EbMSMessageProcessor.builder()
				...
				.acknowledgmentProcessor(acknowledgmentProcessor)
				.build()
				.processRequest(timestamp, document, message);
	}
