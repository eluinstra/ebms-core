 ...
 */
package nl.clockwork.ebms.server.servlet.filters;
...
public class EchoServletFilter implements Filter
{
	...
	{
		headerNames.forEach(name -> ((HttpServletResponse)response).setHeader(name, ((HttpServletRequest)request).getHeader(name)));
