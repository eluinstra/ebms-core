 ...
 */
package nl.clockwork.ebms.api.certificate.model;
...
public class CertificateMapping
{
	...
	public static CertificateMapping of(nl.clockwork.ebms.common.cpa.certificate.CertificateMapping m)
	{
		try
		{
	...
	public nl.clockwork.ebms.common.cpa.certificate.CertificateMapping toCertificateMapping()
	{
		try
		{
