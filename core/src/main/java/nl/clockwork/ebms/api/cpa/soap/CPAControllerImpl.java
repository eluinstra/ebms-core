...
import nl.clockwork.ebms.api.cpa.repository.CPARepository;
import nl.clockwork.ebms.api.cpa.validator.CPAValidator;
...
public class CPAControllerImpl implements CPAController
{
	...
	public void validateCPAImpl(String cpa) throws SAXException, IOException, ParserConfigurationException, JAXBException
	{
	...
	public String insertCPAImpl(String cpa, Boolean overwrite) throws SAXException, IOException, ParserConfigurationException, JAXBException
	{
		log.debug("InsertCPA");
		xsdValidator.validate(cpa);
		val parsedCpa = JAXBParser.getInstance(CollaborationProtocolAgreement.class).handle(cpa);
	...
	public void deleteCPAImpl(String cpaId)
	{
	...
	public List<String> getCPAIdsImpl()
	{
		log.debug("GetCPAIds");
	...
	public String getCPAImpl(String cpaId) throws JAXBException
	{
