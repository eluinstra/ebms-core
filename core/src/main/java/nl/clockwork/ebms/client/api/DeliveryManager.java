 ...
 */
package nl.clockwork.ebms.client.api;
...
public interface DeliveryManager
{
	...
	void handleResponseMessage(final EbMSResponseMessage message) throws EbMSProcessorException;

	void sendResponseMessage(final String uri, final EbMSBaseMessage response) throws EbMSProcessorException;
}
